...
### Changed
- **Product and repository rebrand** - renamed the public product to Agent Notifications and the repository to `agent-notifications`; existing plugin IDs, commands, binary and release asset names, environment variables, OS integration IDs, and configuration paths remain unchanged for compatibility.
